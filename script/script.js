$(document).ready(function () {
    ...
    counterUp.on('click', function(){    //отслеживаем клик по кнопке вверх
       if(currentFlor < 18){
        ...
        addZeroFloor = currentFlor.toLocaleString('en-US',{minimumIntegerDigits:2, useGrouping:false});   //форматируем переменную с этажом чтобы было 01 а не 1
   ...
   counterDown.on('click',function(){
    if(currentFlor > 2){
        currentFlor--;
        addZeroFloor = currentFlor.toLocaleString('en-US',{minimumIntegerDigits:2, useGrouping:false});
